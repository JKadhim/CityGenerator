...
public class FPPlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        this.characterController.Move(runMultiplier * this.MovementSpeed * Time.deltaTime * movementVector);
        ...
        this.characterController.Move(this.verticalSpeed * Time.deltaTime * Vector3.up);
    }
